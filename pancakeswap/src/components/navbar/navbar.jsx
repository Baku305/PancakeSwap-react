...
import networkButtonArrow from "../../assets/networkButtonArrow.svg";
    ...
    <>
      ...
      >
                ...
                return (
                  <div key={i} className="menu_el_wrapper">
                    <div className="menu_title_wrapper">
                      ...
                      {el.news && <div className="news_icon"></div>}
                    </div>
        ...
        <div className="nav_right_wrapper">
          ...
          <div
            className="network_button_wrapper"
            onMouseEnter={() => setLanguageOpen(false)}
          >
            <div
              color=""
            ...
            >
              {width > 1055 && network === "bnb" ? (
                <span className="ButtonTitle">BNB Smart Chain</span>
              ) : width > 1055 && network === "eth" ? (
                <span className="ButtonTitle">Ethereum</span>
              ) : width > 535 && network === "bnb" ? (
                <span className="ButtonTitle">BNB</span>
              ) : width > 535 && network === "eth" ? (
                <span className="ButtonTitle">ETH</span>
              ) : network === "bnb" ? (
              ...
              <img
                className="network_button_logo"
                src={network === "eth" ? ethLogo : bnbLogo}
                alt="logo"
              />
              <svg
                data-src={networkButtonArrow}
                alt="arrow"
                className="network_button_arrow"
              />
            </div>
            <VerticalMenu array={networkList} value={setNetwork}/>
          </div>
          <div
