    ...
    <>
      ...
      <div className={scrollPosition < 300 ? `nav_wrapper nav_wrapper_entry ${theme}-theme` : `nav_wrapper nav_wrapper_hidden ${theme}-theme` }>
        <div className="nav_left_wrapper">
          ...
          {width > 620 && <div className="menu_wrapper">
            {menu.map((el, i) => {
              return (
        ...
        <div className="nav_right_wrapper">
          ...
          <div className="pancake_asset_value_wrapper">
            <img src={pancakeLogoButton} alt="" className="pancake_asset_value_wrapper" />
            <h4>$4.500</h4>
          </div> : <div className="pancake_asset_value_wrapper">
            <img src={pancakeLogoButton} alt="" className="pancake_asset_value_wrapper" />
          </div>}
          <svg
            viewBox="0 0 24 24"
          ...
          <Button color="" onClick={() => console.log("ciao")} buttonStyle={"btn--connect"}>
            {width > 940 ? <span className="ButtonTitle">Connect Wallet</span> : <span className="ButtonTitle">Connect</span>}
          </Button>
        </div>
      </div>
      {width < 620 && <div className={`mobile_menu_wrapper ${theme}-theme`}>
            {menu.map((el, i) => {
              return (
