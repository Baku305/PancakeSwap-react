...
import Image1 from "../../assets/asset 32.png"
import Image2 from "../../assets/asset 33.png"
import Image3 from "../../assets/asset 31.png"
import Image4 from "../../assets/asset 34.png"
import Image5 from "../../assets/asset 35.png"
import Image6 from "../../assets/asset 36.png"
            ...
            <div className="loginSection-container">
                <div className="loginSection-content">
                    <div className="svg-rays-container">
                        <div className="svg-rays">
                            <svg viewBox="0 0 1956 1956" className="sc-6457768a-0 bYguAj sc-9eaff88b-1 kwMZDt" color="text"
                    ...
                    <div className="svg-coin-container">
                        <div className="svg-coin-top">
                            <div className="svg-coin-flex-container">
                                <div className="coin-item-top animation-1">
                                    <img src={Image1} height="256px" width="256px" alt=""/>
                                </div>
                                <div className="coin-item-top animation-2">
                                    <img src={Image2} height="256px" width="256px" alt=""/>
                                </div>
                                <div className="coin-item-top animation-3">
                                    <img src={Image3} height="256px" width="256px" alt=""/>
                                </div>
                            </div>
                        </div>
                        <div className="svg-coin-bottom">
                            <div className="svg-coin-flex-container">
                                <div className="coin-item-bottom animation-1">
                                    <img src={Image4} width="256px" height="256px" alt=""/>
                                </div>
                                <div className="coin-item-bottom animation-2">
                                    <img src={Image5} width="256px" height="256px" alt=""/>
                                </div>
                                <div className="coin-item-bottom animation-3">
                                    <img src={Image6} width="256px" height="256px" alt=""/>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div className="content-text">
                        <h2>Starts in seconds</h2>
                        <div className="text-link">Connect your crypto wallet to start using the app in seconds.</div>
