...
const WinMilionsInPrizes = () =>{
    return(
    <div className="win-milions-wrapper">
        <div className="win-milions-container">
            <h2 className="win-milions-container-title">
                <span className="win-milions-container-win">win </span>
                 milions in prizes</h2>
            <p className="win-milions-container-paragraph">Provably fair, on-chain games.</p>
            <p className="win-milions-container-paragraph 
