...
import "./_footer.scss";
//import angelo from "../../assets/" importare il singolo file svg con la variabile indicata per poi poterla mappare e renderizzare dinamicamente gli svg
//gestire meglio il file scss con maggiore annidamento e classi o in camelCase o trattini
//esportare gli array di oggeti in file esterni ed importarli per pulire codice
                ...
                <div className="footer-lists-container">
                    {/* mapping dei vari titoli relativi ad ogni menù */}
                    {
                        footerMenu.map((item, index) => {
                            return (
                                <div key={item + index}>
                                    <div className="menuTitle">{item.title.toUpperCase()}</div>
